<template>
    <div class="p-md w-full lg:w-3/4 mx-auto">
        <section>
            <pre class="p-sm">{{
                groupRegistry
                    .resolveResults()
        ...
        <section class="select-none">
            <nav class="flex">
                ...
                <button class="bg-gray-200 rounded py-xs px-sm" @click="groupRegistry.addGroup('')">
                    Add
                </button>

                <button class="ml-md bg-gray-200 rounded py-xs px-sm" @click="groupRegistry.save()">
                    Save groups
                </button>
            </nav>
                    ...
                    <div class="inline-block">
                        ...
                        >
                            <span
                                ...
                                class="inline-block rounded px-md py-sm bg-gray-100 mr-sm mb-md"
                                :class="
